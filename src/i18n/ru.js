export default {
    ...
    dialog: {
        ...
        banPeer: {
            ...
            message: "Введите время, на которое нужно забанить пира.\nПо-умолчанию 3600 = 1 час.",
            ok: "Забанить"
        },
        copyAddress: {
    ...
    notification: {
        ...
        errors: {
            ...
            negativeAmount: "Сумма не может быть негативной",
    ...
    strings: {
        ...
        daemon: {
            local: {
                ...
                description: "Полная безопасность, кошелек загрузит полный блокчейн. Вы не сможете совершать платежи до завершения синхронизации."
            },
            localRemote: {
                title: "Локальная + Удаленная Нода",
                description: "Начните рабоать с кошельком быстрее, используя эту опцию (по-умолчанию). Кошелек загрузит полный блокчейн, но до окончания синхронизации будет использовать удаленную ноду."
            },
            remote: {
